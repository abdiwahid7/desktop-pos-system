  ...
  return (
    <div className="p-8">
      ...
      <form className="space-y-4 max-w-md">
        ...
        <textarea className="w-full border px-3 py-2 rounded" placeholder="Statement Details" />
        <button className="bg-blue-600 text-white px-4 py-2 rounded" type="submit">Modify</button>
      </form>
    </div>
  );
};
