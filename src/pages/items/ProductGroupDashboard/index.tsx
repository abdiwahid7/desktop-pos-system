    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 p-6">
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow p-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
          <div>
            <h1 className="text-2xl font-bold text-blue-700 mb-1">Product Groups</h1>
            <p className="text-gray-500">Manage and organize your product groups.</p>
          </div>
          <button
          ...
          <table className="min-w-full bg-white border rounded-lg">
            ...
            <tbody>
              {filteredGroups.length === 0 && (
                <tr>
                  <td colSpan={4} className="py-4 text-center text-gray-400">No groups found.</td>
                </tr>
              )}
